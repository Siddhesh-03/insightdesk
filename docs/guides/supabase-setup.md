...
3. Set a **project name** (e.g. `InsightDesk`).
...
InsightDesk uses Alembic from the Python backend to manage database schema. Do not create production tables manually in the Supabase dashboard.
